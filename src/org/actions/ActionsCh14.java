...
public class ActionsCh14 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement women = driver.findElement(By.xpath("//div//span[text()='Women']"));
		a.moveToElement(women).perform();
		Thread.sleep(2000);
		WebElement slipper = driver.findElement(By.xpath("//div//a[text()='Flats']"));
		a.moveToElement(slipper).perform();
		slipper.click();
	}
